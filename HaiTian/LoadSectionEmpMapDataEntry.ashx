<%@ WebHandler Language="C#" Class="LoadSectionEmpMapDataEntry" %>
...
public class LoadSectionEmpMapDataEntry : IHttpHandler {
    ...
    public void ProcessRequest(HttpContext context)
    {
        ...
        string Msg = "";
        string str = @"select id,emp.FNumber,emp.FName,rate from t_SectionEmpMapping s 
